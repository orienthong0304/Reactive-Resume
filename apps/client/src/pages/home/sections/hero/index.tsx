  ...
  <section id="hero" className="relative">
    ...
    <div className="mx-auto max-w-7xl px-6 lg:flex lg:h-screen lg:items-center lg:px-12">
      ...
      >
        ...
        <div className="mt-10 space-y-2">
          <h6 className="text-base font-bold tracking-wide">{t`First,`}</h6>
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
            {t`基于 Reactive-Resume 的简历构建器`}
          </h1>
        </div>

        <p className="prose prose-base prose-zinc mt-6 text-lg leading-8 dark:prose-invert">
          {t`基于 Reactive-Resume 的简历构建器，支持简历生成、简历编辑、简历预览、简历下载等功能。`}
        </p>
    ...
    <div className="mx-auto max-w-7xl px-6 lg:flex lg:h-screen lg:items-center lg:px-12">
      ...
      >
        ...
        <div className="mt-10 space-y-2">
          <h6 className="text-base font-bold tracking-wide">{t`Second,`}</h6>
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
            {t`基于 OpenAI 的表格数据分析工具`}
          </h1>
        </div>

        <p className="prose prose-base prose-zinc mt-6 text-lg leading-8 dark:prose-invert">
          {t`基于 OpenAI 的表格数据分析工具，支持表格数据分析、表格数据生成、表格数据编辑、表格数据预览、表格数据下载等功能。`}
        </p>
          ...
          >
            <Tilt {...defaultTiltProps}>
              <img
                width={3600}
                height={2078}
                src="/screenshots/builder-excel.jpg"
                alt="Reactive Resume - Screenshot - Builder Screen"
                className="w-[76rem] rounded-lg bg-background/5 shadow-2xl ring-1 ring-foreground/10"
              />
            </Tilt>
